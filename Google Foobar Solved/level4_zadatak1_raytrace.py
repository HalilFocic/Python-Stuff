class Graph:
    #Klasa Graph koja u sebi sadrzi gcd koja stalno mijenja mjesta dok y postoji
    #dead lock nam vraca da li ce beskonacno igrati dva igraca
    # vraca mogu li se matchati dva majmuna
    ...
    # Vrati true ako je matching ova dva majmuna moguc
    def bpm(self, u, matchR, seen):
        for v in range(self.list_len):
            if self.graph[u][v] and seen[v] == False:
                seen[v] = True # Ako moze marka ga kao visited da ne bi kasniej opet na to doslo
    ...
    #Vrati broj poduranja
    def maxGaurdPair(self):
        matchR = [-1] * self.list_len
        result = 0
        # Brojac koji broji broj cuvara koji mozemo matchati 
